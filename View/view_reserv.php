...
<div class="container-fluid" >
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <text>
                ...
                <br><br>Nous ferons tout pour que vous passiez un agreable trajet
    ...
    <div id="reserv" class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <table class="table" style="text-align:center">
                    ...
                    <tr>
                        <th style="text-align:center">Age</th> <th style="text-align:center">Prix</th>
                    </tr>

                    <tbody>
                    <tr>
                        <td>< 25 ans:</td> <td>10 &euro;</td>
                    </tr>
                    <tr>
                        <td>> 25 ans:</td> <td>20 &euro;</td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    <caption><b>R&eacute;servation</b></caption>
                    ...
                    <tr>
                        <td style="text-align:center"><b>Assurance annulation (5 &euro;):</b></td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <button class="btn btn-danger" name="cancel" type="submit" value="Annuler la r&eacute;servation">
